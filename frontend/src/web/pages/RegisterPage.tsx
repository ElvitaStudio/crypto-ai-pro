    ...
    <div style={S.page}>
      <div style={S.card}>
        <div style={{ textAlign: 'center', marginBottom: 16 }}>
          ...
          <div style={S.title}>Создать аккаунт</div>
          <div style={S.subtitle}>MarketPulse Pro</div>
        </div>

        <div style={S.trialBadge}>
          ✅ Первые 24 часа — бесплатно. Без карты.
        </div>

        {error && <div style={S.error}>{error}</div>}

        <form onSubmit={handleSubmit}>
          <label style={S.label}>Имя (необязательно)</label>
          <input
            style={S.input}
            type="text"
            placeholder="Иван"
          ...
          <input
            ...
            required
          />
          <label style={S.label}>Подтвердить пароль</label>
          <input
            style={S.input}
            type="password"
